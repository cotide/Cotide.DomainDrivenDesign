...
namespace Cotide.Domain.Contracts.Repositories.Base
{
    ...
    public interface IRepository<TEntity, in TKey> where TEntity : EntityByType<TKey>  
    {
        #region 属性
        ...
        int Create(TEntity entity, bool isSave = true);
        ...
        /// <param name="isSave"> 是否执行保存 </param>
        /// <returns> 操作影响的行数 </returns>
        int Create(IEnumerable<TEntity> entities, bool isSave = true);
