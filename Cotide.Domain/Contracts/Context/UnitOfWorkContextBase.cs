...
namespace Cotide.Domain.Contracts.Context
{
    /// <summary>
    ///     单元操作实现基类
    /// </summary>
    public abstract class UnitOfWorkContextBase : IUnitOfWorkContext
    {
        ...
        public DbSet<TEntity> Set<TEntity, TKey>() where TEntity : EntityByType<TKey>
        {
        ...
        public void RegisterNew<TEntity, TKey>(TEntity entity) where TEntity : EntityByType<TKey>
        {
        ...
        public void RegisterNew<TEntity, TKey>(IEnumerable<TEntity> entities) where TEntity : EntityByType<TKey>
        {
            try
            {
        ...
        /// <typeparam name="TKey">实体主键类型</typeparam>
        /// <param name="entity"> 要注册的对象 </param>
        public void RegisterModified<TEntity, TKey>(TEntity entity) where TEntity : EntityByType<TKey>
        {
        ...
        public void RegisterModified<TEntity, TKey>(Expression<Func<TEntity, object>> propertyExpression, TEntity entity) where TEntity : EntityByType<TKey>
        {
        ...
        /// <typeparam name="TKey">实体主键类型</typeparam>
        /// <param name="entity"> 要注册的对象 </param>
        public void RegisterDeleted<TEntity, TKey>(TEntity entity) where TEntity : EntityByType<TKey>
        {
        ...
        /// <typeparam name="TKey">实体主键类型</typeparam>
        /// <param name="entities"> 要注册的对象集合 </param>
        public void RegisterDeleted<TEntity, TKey>(IEnumerable<TEntity> entities) where TEntity : EntityByType<TKey>
        {
            try
            {
                Context.Configuration.AutoDetectChangesEnabled = false;
